...
def run_traj_linking_workflow(args, linking_dir):
    ...
    # get linking file
    linking_file = glob.glob("{}/*links*ALL.txt.gz".format(linking_dir))
    assert len(linking_file) == 1
