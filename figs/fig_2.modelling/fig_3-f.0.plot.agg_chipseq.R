...
if (dim(data)[2] == 3) {
    ...
    data_melted$variable[data_melted$variable == "pos"] <- "NN-active"
    data_melted$variable[data_melted$variable == "neg"] <- "NN-inactive"
    print(head(data_melted))
    data_melted$variable <- factor(data_melted$variable, levels=c("NN-active", "NN-inactive"))
} else {
